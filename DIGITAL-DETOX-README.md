# Unplug — Digital Detox Full Stack Guide
...
| Project | Path | Stack |
|---------|------|-------|
| REST API | `digital-detox-project/` | Java 21, Spring Boot 3.5, PostgreSQL, Flyway, JWT |
| Web UI | `digital-detox-frontend/` | React 19, TypeScript, Vite, Zod, react-hook-form |
...
3. [Roles and auth](#roles-and-auth)
...
11. [File uploads and downloads](#file-uploads-and-downloads)
12. [Frontend UI and routes](#frontend-ui-and-routes)
...
- **Teen-friendly UI** — dark theme, supportive copy, bento cards, Plus Jakarta Sans font, branded as **Unplug**.
...
- Register a **member** (immediate access).
...
The UI is branded **Unplug** and designed for teens: dark theme, supportive guilt-free copy, bento cards, emoji section headers, and human-readable status labels.
